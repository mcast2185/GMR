  ...
  return (
    <div className="container">
      <Swiper
        ...
        {/* {in this section try and implement height and weight to the images directly} */}
        ...
        <div className="slider-controller">
          <div className="flex h-14 w-28 items-center content-center" >
            <div className="swiper-button-prev slider-arrow-left ">
              {/* <ArrowLeftIcon className=' text-white arrow-element-left'/> */}
            </div>
            <div className="swiper-button-next slider-arrow-right">
              {/* <ArrowRightIcon className=' text-white arrow-element-right'/> */}
            </div>
