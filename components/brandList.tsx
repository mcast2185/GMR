...
function BrandList({brand}: Props) {
  ...
  return (
    <div className="blogList">
      ...
      <header>
        <h1 className="text-black underline decoration-[#992715de]
          text-2xl font-MontserratAlternates m-2 mt-1 pb-4 font-bold">
          [GMR] Gear:
        </h1>
      </header>
      <div className="flex flex-col h-full cursor-default">
        ...
        <div className="flex flex-row overflow-y-scroll 
          md:grid-cols-2 pl-6 gap-14 gap-y-16 pb-24" id="scroll">
