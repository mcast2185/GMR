                ...
                <div className="flex flex-row justify-center items-center pt-[3.7rem] md:pt-1 md:py-1 mb-4 mt-4 md:mt-2 md:mb-2 h-[150px] md:h-[300px] opacity-80">
                  <div className="flex justify-center pr-2 md:pr-6 overflow-hidden cursor-default">
                    ...
                    <h1 className="font-bold p-2 mt-40 rounded-sm bg-[#3c3c3c] scale-90 md:scale-100
                      bg-opacity-80 text-stone-50 mr-0 md:mr-2 text-base font-Quicksand absolute">
...
//       <main className="w-[450px] md:w-full mx-1 md:mx-0  md:scale-100">       
//         <div className="flex flex-row  justify-between" >
//           <div className="flex flex-col px-1 md:px-4 py-10 md:py-0 shrink md:shrink-0 w-[450px] md:w-[720px] justify-between cursor-default bg-transparent md:bg-[#bab8b76c] dark:bg-opacity-10 md:shadow-md">
//             <figure id="figure" className="md:px-4">
...
//               </iframe>
//             </figure>
//             <div className="h-[300px] md:h-auto max-w-xl md:max-w-[750px] mx-0 pl-10 md:pl-0 md:mx-10 mb-8 md:mb-0 mt-8 md:mt-0 flex justify-center overflow-x-clip">
...
//                   <i><span className="md:hidden stroke-[18px] mix-blend-difference text-5xl absolute top-[-5rem] left-[15rem] text-black stroke-white hover:text-transparent hover:stroke-black z-30 transition-transform duration-800 ease-in-out">GMR</span></i>
//                 </h1>
//                 <div className="flex flex-row justify-center items-center pt-[3.7rem] md:pt-1 md:py-1 mb-4 mt-4 md:mt-2 md:mb-2 h-[150px] md:h-[300px] opacity-80">
...
//                 justify-center md:justify-start overflow-hidden shrink md:shrink-0">
//                 <Link href="/media">
//                   <Image className="h-full w-[380px] md:w-[670px] object-cover overflow-hidden
//                     hover:scale-105 transition-transform duration-200 ease-in-out"
//                     src={BOMB} alt="The Bombcast"/>
//                 </Link>
//                 <h1 className="font-semibold p-2 rounded-sm bg-[#3c3c3c] 
...
//             <div className="flex flex-col md:flex-row w-full relative shrink md:shrink-0 mx-auto md:mx-0">
//               <div className="mb-2 md:mb-5 pr-3 md:pt-8 flex justify-between w-[450px] md:w-[600px] scale-75 md:scale-100" >
...
//                   allowFullScreen={false} width="672" height="350" title="YouTube video player"
//                   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share "
//                   className="h-64 w-[450px] md:w-[670px] md:h-[350px]">
//                 </iframe>
//               </figure>
//               <div className="pl-2">
